          ...
          <div class="container-fluid container-fullw bg-white">
            <div class="row">
              <div class="col-md-12">
                ...
                <form name="formInput" id="formInput" method="post" action="{{ url('research_registration/selected') }}">
                  {{ csrf_field() }}
                        ...
                        @if (isset($result))
                          ...
                          @foreach ($result as $row)
                            <tr>
                              ...
                              <td>
                                <a class="btn btn-success padding-right-5 padding-left-5" href="{{ url('research_registration/view/'.$row->id) }}">
                                  <i class="fa fa-list"></i> ดูข้อมูล</a>
                                @if($menu_super || $menu_write)  
                                <a class="btn btn-warning padding-right-5 padding-left-5" href="{{ url('research_registration/edit/'.$row->id) }}">
                                  <i class="glyphicon glyphicon-edit"></i> แก้ไข</a>
                                @endif
                                @if($menu_super) 
                                <a class="btn btn-red btn-delete-row padding-right-5 padding-left-5" onclick="delete_data(&#39;delete&#39;,'{{ $row->id }}', '{{ $row->project_name_th }}');">

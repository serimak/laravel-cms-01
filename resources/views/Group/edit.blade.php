								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" placeholder="Insert your First Name" name="role_name" class="form-control" id="role_name" value="{{ $result->role_name }}">
										</div>
										...
										<div class="form-group">
											...
											<div>
												<div class="checkbox clip-check check-primary checkbox-inline">
													<input type="checkbox" name="cms_level" id="cms" value="1" {{ ($result->cms_level?'checked=""':'') }}>
													<label for="cms">
														CMS Level
													</label>
												</div>
												<div class="checkbox clip-check check-primary checkbox-inline">
													<input type="checkbox" name="sa_level" id="sa" value="1" {{ ($result->sa_level?'checked=""':'') }}>
													<label for="sa">
														SA Level
													</label>
												</div>
										...
										<div class="form-group">
											...
											<select class="form-control" id="group_superadmin" name="permission_s">
												<option value="n" {{ ($permission_s=="n"?'selected=""':'') }}>No</option>
												<option value="y" {{ ($permission_s=="y"?'selected=""':'') }}>Yes</option>
											</select>
										</div>
										@endif
										...
										<div class="form-group">
											<label class="control-label text-bold">
												Permissions <span class="symbol required"></span>
											</label>
									...
									<!-- ########################################################################### -->
										...
										foreach ($all_menu as $key => $menu) {
								            ...
								            $html .= '<div class="form-group">
													<div class="row checkbox clip-check check-primary">
														<div class="col-md-4 margin-top-5">
															<input type="checkbox" class="parentCheckBox" name="menu[mmu]['.$menu['id'].']" id="'.$menu['menu_name'].'" value="1" data-set=".menu_'.$menu['id'].'" '.$menu['checked'].'>
														...
														<div class="col-md-6 menu_'.$menu['id'].'">
															<span class="text-bold">
																&nbsp;&nbsp;&nbsp;
																<div class="checkbox clip-check check-primary checkbox-inline">
																	<input type="checkbox" name="permission_r[mmu]['.$menu['id'].']" id="r_menu_'.$menu['id'].'" value="1" '.$menu['permission_r'].'>
																	<label for="r_menu_'.$menu['id'].'">
																		Read
																	</label>
																</div>
																<div class="checkbox clip-check check-primary checkbox-inline">
																	<input type="checkbox" name="permission_w[mmu]['.$menu['id'].']" id="w_menu_'.$menu['id'].'" value="1" '.$menu['permission_w'].'>
																	<label for="w_menu_'.$menu['id'].'">
																		Write
																	</label>
																</div>
																<div class="checkbox clip-check check-primary checkbox-inline">
																	<input type="checkbox" name="permission_d[mmu]['.$menu['id'].']" id="e_menu_'.$menu['id'].'" value="1" '.$menu['permission_d'].'>
													...
													foreach ($menu['submenu'] as $k => $submenu) {
														...
														$html .= '<div class="row checkbox clip-check check-primary margin-left-30 menu_'.$menu['id'].'">
															<div class="col-md-4 margin-top-5">
																<input type="checkbox" class="childCheckBox" name="menu[smu]['.$submenu['id'].']" id="'.$submenu['submenu_name'].'" value="1" data-set=".submenu_'.$menu['id'].'_'.$submenu['id'].'" '.$submenu['checked'].'>
															...
															<div class="col-md-6 submenu_'.$menu['id'].'_'.$submenu['id'].'" style="margin-left: -30px;">
																<span class="text-bold">
																	&nbsp;&nbsp;&nbsp;
																	<div class="checkbox clip-check check-primary checkbox-inline">
																		<input type="checkbox" name="permission_r[smu]['.$submenu['id'].']" id="r_submenu_'.$menu['id'].'_'.$submenu['id'].'" value="1" '.$submenu['permission_r'].'>
																		<label for="r_submenu_'.$menu['id'].'_'.$submenu['id'].'">
																			Read
																		</label>
																	</div>
																	<div class="checkbox clip-check check-primary checkbox-inline">
																		<input type="checkbox" name="permission_w[smu]['.$submenu['id'].']" id="w_submenu_'.$menu['id'].'_'.$submenu['id'].'" value="1" '.$submenu['permission_w'].'>
																		<label for="w_submenu_'.$menu['id'].'_'.$submenu['id'].'">
																			Write
																		</label>
																	</div>
																	<div class="checkbox clip-check check-primary checkbox-inline">
																		<input type="checkbox" name="permission_d[smu]['.$submenu['id'].']" id="e_submenu_'.$menu['id'].'_'.$submenu['id'].'" value="1" '.$submenu['permission_d'].'>
																		<label for="e_submenu_'.$menu['id'].'_'.$submenu['id'].'">
																			Delete
																		</label>
																	</div>
																</span>

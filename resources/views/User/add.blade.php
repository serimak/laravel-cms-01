								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" placeholder="Text Field" class="form-control" id="firstname_th" name="firstname_th" value="{{ old('firstname_th') }}">
										</div>
										<div class="form-group">
											<label class="control-label text-bold">
												ชื่อกลาง
											</label>
											<input type="text" placeholder="Text Field" class="form-control" id="middlename_th" name="middlename_th" value="{{ old('middlename_th') }}">
										</div>
										<div class="form-group">
											<label class="control-label text-bold">
												นามสกุล <span class="symbol required"></span>
											</label>
											<input type="text" placeholder="Text Field" class="form-control" id="lastname_th" name="lastname_th" value="{{ old('middlename_th') }}">
										</div>
										<div class="form-group">
											<label class="control-label text-bold">
												First Name <span class="symbol required"></span>
											</label>
											<input type="text" placeholder="Text Field" class="form-control" id="firstname_en" name="firstname_en" value="{{ old('middlename_th') }}">
										</div>
										<div class="form-group">
											<label class="control-label text-bold">
												Middle Name
											</label>
											<input type="text" placeholder="Text Field" class="form-control" id="middlename_en" name="middlename_en" value="{{ old('middlename_th') }}">
										</div>
										<div class="form-group">
											<label class="control-label text-bold">
												Last Name <span class="symbol required"></span>
											</label>
											<input type="text" placeholder="Text Field" class="form-control" id="lastname_en" name="lastname_en" value="{{ old('middlename_th') }}">
										</div>
										<div hidden class="form-group">
											<label class="control-label text-bold">
												Citizen ID
											</label>
											<input type="text" placeholder="Text Field" class="form-control" id="citizen_id" name="citizen_id" value="{{ old('citizen_id') }}">
										</div>
										<div hidden class="form-group">
											<label class="control-label text-bold">
												Passport ID
											</label>
											<input type="text" placeholder="Text Field" class="form-control" id="passport_id" name="passport_id" value="{{ old('passport_id') }}">
										</div>
										<div hidden class="form-group">
											<label class="control-label text-bold">
												Library Code
											</label>
											<input type="text" placeholder="Text Field" class="form-control" id="library_code" name="library_code" value="{{ old('middlename_th') }}">
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="clip-radio radio-primary">
												<input type="radio" value="Female" name="gender" id="us-female" {{ old('gender')=="Female" ? 'checked="checked"' : '' }}>
												<label for="us-female">
													Female
												</label>
												<input type="radio" value="Male" name="gender" id="us-male" {{ old('gender')=="Male" ? 'checked="checked"' : '' }}>
												<label for="us-male">
													Male
												</label>
												<input type="radio" value="Other" name="gender" id="us-other" {{ old('gender')=="Other" ? 'checked="checked"' : '' }}>
												<label for="us-other">
													Other
												</label>
											</div>
										...
										<div class="form-group">
											...
											<div class="clip-radio radio-primary">
												...
												@foreach($titles as $title)
													...
													<option @if(old('title_id') == $title->id) selected @endif value="{{ $title->id }}">{{ $title->title_name_th }}</option>
												@endforeach
												</select>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<select name="nationallity_id" id="nationallity_id" class="cs-select cs-skin-elastic">
											    @foreach($nationalities as $key => $text)
											        <option @if(old('nationallity_id') === $key) selected @endif value="{{ $text->id }}">{{ $text->nationality_name }}</option>
											    @endforeach
											</select>
										</div>
										<div class="form-group">
											...
											<select name="group_id" id="group_id" class="cs-select cs-skin-elastic">
											    @foreach($groups as $key => $text)
											        <option @if(old('group_id') === $key) selected @endif value="{{ $text->id }}">{{ $text->group_name_th }}</option>
											    @endforeach
											</select>
										</div>
										<div class="form-group">
											...
											<select name="role_id" id="role_id" class="cs-select cs-skin-elastic">
											    @foreach($roles as $key => $text)
											        <option @if(old('role_id') === $key) selected @endif value="{{ $text->id }}">{{ $text->role_name }}</option>
											    @endforeach
											</select>
										</div>
										{{-- <div class="form-group">
